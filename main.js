...
client.on('message', message => {
  ...
  if(message.member.roles.find("name", "GUEST")){
	...
	if(commandIs("database_loadup")){
	message.channel.send("Loading up all data from current servers.")
	 //CPU Stuff
     function cpuAverage() {
       var totalIdle = 0,
         totalTick = 0;
     ...
     setTimeout(function() {
         ...
         const rich = new Discord.RichEmbed()
           .setTitle("Database")
           .setDescription("Shows you the server who purchased hexcore-beta")
           .setColor(0xd38cff)
           ...
           .addField("Guilds", "Canadian Armed Forces", true)
           .addField("Users", botMembers, true)
           .addField("Membership", `VIP`, true)
...
if (commandIs("help")) {
  const embed = new Discord.RichEmbed()
    ...
    .setDescription(`All the commands provided for the release version of hexcore-beta. Default prefix is ${prefix}`)
    .setColor(0x70b080)
